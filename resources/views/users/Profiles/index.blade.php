                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="card h-100">
                                    <div class="card-body">
                                       ...
                                       <a href="#"><p class="text-center"><strong class="text-right">{{$questionnaire->project_name}}</strong> : <small class="text-left">{{$questionnaire->created_at->format('Y-m-d')}}</small></p></a>
                                            @endforeach
                                    </div>
                                </div>
                            </div>
